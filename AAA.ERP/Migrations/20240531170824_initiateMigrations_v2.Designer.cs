...
namespace AAA.ERP.Migrations
{
    ...
    [Migration("20240531170824_initiateMigrations_v2")]
    partial class initiateMigrations_v2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Account.Models.Entities.ChartOfAccount.ChartOfAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.Account.Models.Entities.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Domain.Account.Models.Entities.SubLeadgers.CashInBox", b =>
                {
                    ...
                    b.ToTable("CashInBox", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Account.Models.Entities.ChartOfAccount.ChartOfAccount", b =>
                {
                    ...
                    b.HasOne("Domain.Account.Models.Entities.ChartOfAccount.ChartOfAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Domain.Account.Models.Entities.Identity.ApplicationUser", null)
                        .WithMany()
