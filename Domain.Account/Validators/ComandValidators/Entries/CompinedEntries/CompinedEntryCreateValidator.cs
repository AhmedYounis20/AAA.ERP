...
namespace Domain.Account.Validators.ComandValidators.Entries.CompinedEntries;

public class CompinedEntryCreateValidator : BaseCreateValidator<CompinedEntryCreateCommand, Entry>
{
    public CompinedEntryCreateValidator()
    {
